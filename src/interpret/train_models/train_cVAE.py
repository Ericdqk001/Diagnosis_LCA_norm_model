...
# python src/interpret/train_models/train_cVAE.py --data_path "data/processed_data" --feature_type "cortical_surface_area" --project_title "interpret_cVAE" --batch_size 256 --learning_rate 0.0005 --latent_dim 1 --hidden_dim "10-10"
...
# Select the relevant features to interpret
...
FEATURES = [FEATURES[i] for i in relevant_feature_indices]
...
def train(
    ...
    for epoch in range(1, config.epochs + 1):
        ...
        if epochs_no_improve >= tolerance:
            ...
            model_checkpoint_name = "interpret_dim_4_sa_latent_dim_1.pt"
...
if __name__ == "__main__":
    ...
    with wandb.init(
        project=f"cVAE_{feature_type}_interpret_dim_4",
        config={

...
# Define the plot_cbcl_means function
def plot_cbcl_means(
    df,
    ...
    # Define the same bright colors used in the provided code
    bright_colors = [
        "#FF5733",
        "#33FF57",
        "#3357FF",
    ...
    for class_id in sorted(df["predicted_class"].unique()):
        ...
        plt.plot(
            ...
            markeredgecolor=bright_colors[
                class_id - 1
            ],  # Color the marker edge using the same colors as the provided code

...
python cVAE_tune.py --data_path "/home/ericdeng/lca_psydx/processed_data" --feature_type "cortical_thickness" --project_title "cVAE_cortical_thickness_UCL_hyper_tune"
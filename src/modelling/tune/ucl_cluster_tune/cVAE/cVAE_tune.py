...
def get_degree_of_separation(
    ...
    val_cov: np.ndarray,
    inter_val_cov: np.ndarray,
    exter_val_cov: np.ndarray,
    high_val_cov: np.ndarray,
) -> float:
    ...
    inter_val_latent, _ = model.pred_latent(
        inter_val_data_pd,
        inter_val_cov,
        DEVICE,
    )
    exter_val_latent, _ = model.pred_latent(
        exter_val_data_pd,
        exter_val_cov,
        DEVICE,
    )
    high_val_latent, _ = model.pred_latent(
        high_val_data_pd,
        high_val_cov,
        DEVICE,
    )
    ...
    inter_glass_delta = glass_delta(
        val_distance,
        inter_val_distance,
    )

    exter_glass_delta = glass_delta(
        val_distance,
        exter_val_distance,
    )

    high_glass_delta = glass_delta(
        val_distance,
        high_val_distance,
    )
...
def train_k_fold(
    ...
    inter_val_cov = one_hot_encode_covariate(
        data,
        "demo_sex_v2",
        INTER_VAL_SUBS,
    )
    ...
    exter_val_cov = one_hot_encode_covariate(
        data,
        "demo_sex_v2",
        EXTER_VAL_SUBS,
    )
    ...
    high_val_cov = one_hot_encode_covariate(
        data,
        "demo_sex_v2",
        HIGH_VAL_SUBS,
    )
